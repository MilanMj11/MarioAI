...
class PlayerGenetic(PhysicsEntity):  # Inherit from PhysicsEntity
    ...
    def die(self):
        ...
        if self.lives <= 0:
            ...
            fitness = self.max_pos + self.score // 10 + self.coins * 10 + self.touched_finish * 10000
            self.game.fitness.append(fitness)
            # print(self.pos[0])
    ...
    def update(self, movement=(0, 0)):
        ...
        if self.game.currentLevel.current_time < 250 and self.game.player.pos[0] < 500:
            self.game.player.die()

        if self.game.currentLevel.current_time < 200 and self.game.player.pos[0] < 1000:
            self.game.player.die()

        if self.game.currentLevel.current_time < 150 and self.game.player.pos[0] < 1500:
            self.game.player.die()
